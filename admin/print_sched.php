                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <table id="example1" class="table table-bordered dataTable no-footer" role="grid" aria-describedby="example1_info">
                                    ...
                                    <tbody>
                                        <?php
//                $sql = "SELECT * FROM senate_list, senate_sched WHERE senate_list.sched_id = senate_sched.sched_id ";
      $sql = "SELECT * FROM senate_attendance, senate_sched WHERE senate_attendance.schedule = senate_sched.sched_id ";
                ...
                ?>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <button class="btn btn-success btn-flat sched_change" id="<?php echo $row['senate_id']; ?>"><i class="fas fa-edit"></i></button>
                                            </td>
                                        </tr>
                                        <?php
                }
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h4 class="modal-title">Add Senator</h4>
